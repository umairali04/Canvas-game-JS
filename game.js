    ...
    function action(e) {
        if (playing) {
            ...
            var bullet2 = {
                ...
                dirX: e.offsetX,
                dirY: e.offsetY,
                deg: Math.atan2(e.offsetX - (cW / 2), -(e.offsetY - (cH / 2))) + Math.PI / 60, // Increased angle difference
                destroyed: false
            };
            var bullet3 = {
                x: -8,
                ...
                dirX: e.offsetX,
                dirY: e.offsetY,
                deg: Math.atan2(e.offsetX - (cW / 2), -(e.offsetY - (cH / 2))) + Math.PI / 30, // Increased angle difference
                destroyed: false
            };
            ...
            var bullet4 = {
                ...
                dirX: e.offsetX,
                dirY: e.offsetY,
                deg: Math.atan2(e.offsetX - (cW / 2), -(e.offsetY - (cH / 2))) + Math.PI / 25, // Increased angle difference
                destroyed: false
            };
